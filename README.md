...
2. Cookie 是按需项，普通公开视频可以先不配置；
3. 如果 YouTube 提示人机验证，进入“设置 → Cookie 配置”选择本机浏览器；
4. 如果解析突然失效，可在“设置 → yt-dlp 更新”更新到官方 Nightly。
5. 如果网络超时或无法连接，可在“设置 → 网络与连接测试”配置代理并运行诊断。

成功标志：向导中的三个必需项目显示绿色勾，随后可以在首页粘贴链接并解析。
